...
<body>
 <div class="container">
        <div class="card card-container">
            ...
            <form method="post" accept-charset="utf-8" action="loginAdmnistrador" name="loginform"  role="form" class="form-signin">
			       <c:if test="${requestScope.mensaje8 != null}">
               		<div class="alert alert-danger fade in" id="success-alert">
				      
				        <strong>${requestScope.mensaje8}</strong>
				    </div>
				    </c:if>
			                <span id="reauth-email" class="reauth-email"></span>
                <input class="form-control" placeholder="Usuario" name="louser" type="text"  required>
                <input class="form-control" placeholder="Contraseña" name="lopassword" type="password"   required>
